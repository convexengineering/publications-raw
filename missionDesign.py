...
# Objective contours
CS = plt.contour(W_p,Range,Obj)
plt.xlabel('Payload weight (N)')
plt.ylabel('Range (km)')
plt.title('Objective contours')
plt.clabel(CS,inline=1,fontsize=10,fmt='%1.3g')
plt.grid()
plt.savefig('figbank/Objcontours.png')
plt.close()

# Time cost contours
CS = plt.contour(W_p,Range,timecost)
plt.xlabel('Payload weight (N)')
plt.ylabel('Range (km)')
...
CS = plt.contour(W_p,Range,Vffuse/Vftotal)
plt.xlabel('Payload weight (N)')
plt.ylabel('Range (km)')
...
CS = plt.contour(W_p,Range,Vfwing/Vftotal)
plt.xlabel('Payload weight (N)')
plt.ylabel('Range (km)')
...
CS = plt.contour(W_p,Range,Wwcoeff1sens)
plt.xlabel('Payload weight (N)')
plt.ylabel('Range (km)')
...
CS = plt.contour(W_p,Range,Wwcoeff2sens)
plt.xlabel('Payload weight (N)')
plt.ylabel('Range (km)')
...
CS = plt.contour(W_p,Range,W_e_refsens)
plt.xlabel('Payload weight (N)')
plt.ylabel('Range (km)')
...
CS = plt.contour(W_p,Range,CLmaxsens)
plt.xlabel('Payload weight (N)')
plt.ylabel('Range (km)')
...
CS = plt.contour(W_p,Range,h_cruisesens)
plt.xlabel('Payload weight (N)')
plt.ylabel('Range (km)')
...
CS = plt.contour(W_p,Range,Vminsens)
plt.xlabel('Payload weight (N)')
plt.ylabel('Range (km)')
...
CS = plt.contour(W_p,Range,Csens)
plt.xlabel('Payload weight (N)')
plt.ylabel('Range (km)')
...
CS = plt.contour(W_p,Range,rhofsens)
plt.xlabel('Payload weight (N)')
plt.ylabel('Range (km)')
