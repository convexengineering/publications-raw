...
\begin{figure}
    \centering
    \includegraphics[width=0.68\textwidth]{feas_moneq.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.68\textwidth]{feas_posygeq.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.68\textwidth]{feas_posyleq.png}
...
Note that the atmospheric density $\rho$ in Table~\ref{t:vars_WandL}, and other
...
\begin{center}
\captionof{table}{Values of free variables in the SimPleAC model.}
