...
Modeling in GP often begins with a set of assumptions about the configuration 
of the problem. In this case, let's assume that our aircraft has weight, 
which consists of the payload, wing, and fuel weights. 
