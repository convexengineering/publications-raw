...
This section will demonstrate how inequalities derive a simple aircraft problem that will serve as
...
does not change by the relaxation of the monomial equality.
...
This will become more clear as we examine sensitivity information.
...
are especially amenable to being represented by posynomials, since higher weights
penalize most objective functions.
