...
upper unbounded, since lower density is beneficial for drag and most other objective functions.
...
by singular quantities. In fact, when we add an atmospheric model to SimPleAC in
Section~\ref{s:mission}, we will be implementing signomial equalities.
