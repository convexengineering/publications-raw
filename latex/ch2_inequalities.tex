...
structural weight coefficient $W_{w_{coeff2}}$. Note that this equation captures the
major trends in wing structural sizing. The weight grows with the cube of the span ($AR^{1.5}$, derived
...
bending moment relief due to presence of fuel in the wings by performing a geometric average
of the total weight, and the weight excluding wing fuel and wing weight.
