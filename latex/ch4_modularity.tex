...
\begin{forest}
        [\textit{\textbf{Mission}}
            ...
            [\textit{\textbf{\shortstack{Aircraft\\Performance}}}
                ...
                [\textit{\shortstack{Wing\\Performance}}]
                [\textit{\shortstack{VT\\Performance}}]
                [\textit{\shortstack{HT\\Performance}}]
                [\textit{\shortstack{Fuselage\\Performance}}]
                [\textit{\shortstack{Engine\\Performance}}]
            ]
        ]
    \end{forest}
