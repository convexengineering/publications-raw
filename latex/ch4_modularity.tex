...
\begin{figure}[!ht]
\centering
\includegraphics[width=.8\textwidth,natwidth=585,natheight=442]{figures/HTFBD.eps}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width = 0.7\linewidth,natwidth=621,natheight=428]{figures/HTshear.eps}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width = 0.7\linewidth,natwidth=627,natheight=437]{figures/HTmoment.eps}
