...
\begin{enumerate}
    ...
    (although they could be modeled, explained further in Section~\ref{s:HTExtensions}).
...
section of the wing (the blue rectangle in Figure~\ref{f:HTFBD}).
...
`triangular' section of the wing (the blue triangle in Figure~\ref{f:HTFBD}).
