...
%\begin{figure}[htbp]
%\centering
%\subfloat[Non-convex signomial inequality drag constraint.]{\includegraphics[width=0.45\textwidth]{posyapprox0.eps}}\hfill
%\subfloat[Convex approximation about $C_{L} = 0.05$.]{\includegraphics[width=0.45\textwidth]{posyapprox1.eps}}\hfill
%\subfloat[Convex approximation about $C_{L} = 0.20.$]{\includegraphics[width=0.45\textwidth]{posyapprox3.eps}}
%\caption{A signomial inequality constraint and GP approximations about two
