...
\begin{figure}[!h]
    ...
    \begin{forest}
        ...
        \draw[->] (ac) -- (mission1);
        \draw[->] (ac) -- (mission2);
        \node[draw,rectangle,fit={(ap1)}] {};
        \node[draw,rectangle,fit={(ap2)}] {};
        \node[draw,rectangle,fit={(ap3)}] {};
        \node[draw,rectangle,fit={(ap4)}] {};
        \node[draw,circle,fit={(mission1) (ap1) (ap2)}] {};
        \node[draw,circle,fit={(mission2) (ap3) (ap4)}] {};
    \end{forest}
...
and each mission model is vectorized $N_{missions}$ times.
