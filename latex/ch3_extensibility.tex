...
\begin{equation}
	(\frac{W_{eng}}{W_{eng_{max}}})^{0.100} = 0.989 (\frac{P_{shaft}}{P_{shaft_{max}}})^{0.117}
\end{equation}

Note that the root mean square error of this fit is 0.42, but this has to do with 
...
\begin{equation}
	(\frac{W_{eng}}{W_{eng_{max}}})^{1.93} \geq 2.26 (\frac{P_{shaft}}{P_{shaft_{max}}})^{2.90} 
												+0.00215 (\frac{P_{shaft}}{P_{shaft_{max}}})^{0.760}
\end{equation}

This relation has an r.m.s. error of 0.34, which is a significant improvement. 
