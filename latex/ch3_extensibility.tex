...
and see how the fraction of time cost versus total cost through the sensitivity to the cost index.
...
There are still significant weaknesses in the model that mission design exploits to arrive at solutions
...
We can intuit how and why the engine weight does not scale as expected.
...
The SimPleAC was optimized for the 2-mission scenario for both objectives~\ref{e:compObj} and \ref{e:sepObj} and compared against
the single mission solution. The inputs to the model are specified in Table~\ref{t:mminputs}, and the results
