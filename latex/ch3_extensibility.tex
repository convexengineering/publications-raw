...
We have created a mission and flight segment model without having to have a better understanding
...
\begin{figure*}[t!]
    ...
    \begin{subfigure}[t]{0.5\linewidth}
        \centering
        \includegraphics[width=0.9\linewidth]{mission2/Wfcontours.png}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{0.5\linewidth}
        \centering
...
\begin{figure}
    \centering
    \includegraphics[width=0.45\linewidth]{mission2/vffusefraccontours.png}
