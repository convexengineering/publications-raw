...
%can be beneficial for the engineering design process. The mathematical guarantees
%and speed of convex optimization ca
...
Section~\ref{ch3:extensibility} will also discuss the features specific to
